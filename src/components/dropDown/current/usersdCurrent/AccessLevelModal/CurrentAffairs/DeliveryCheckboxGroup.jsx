...
const DeliveryCheckboxGroup = ({ checkedState, setCheckedState, checkParentStatus }) => {
  ...
  return (
    <>
      <div className="form-check d-flex justify-content-end align-items-center ms-4 mt-2 mx-2">
        <label className="form-check-label me-2" htmlFor="delivery" style={{ textDecoration: "underline" }}>
          تحویل آب
        </label>
        <input
      ...
      {checkedState.delivery && (
        <div className="ms-4 mx-3 custom-checkbox" style={{ fontSize: "0.8rem" }}>
          {[
            ...
            { key: "channelValve", label: "مانور دریچه‌ها و شیرآلات سامانه و مخازن" },
